version 1.0
import "https://raw.githubusercontent.com/broadinstitute/warp/develop/tasks/wdl/GermlineVariantDiscovery.wdl" as Calling
import "https://raw.githubusercontent.com/broadinstitute/warp/develop/tasks/wdl/Utilities.wdl" as Utils
import "https://raw.githubusercontent.com/jivesh-enigma/Experimental_CRAM_To_Short_Variants/refs/heads/main/WholeGenomeGermlineSingleSample_v3.1.21_variant_discovery.wdl" as DragenCaller
...
workflow Short_Variant_Pipeline {
    ...
    call VariantFilter {
        input: 
            ...
            clingen_gene_data = clingen_gene_data,
    ...
    call IGV_Snapshots {
        input: 
            ...
            variants_PGx_IGV_bed = VariantFilter.variants_PGx_IGV_bed,
            clinvar_variants_conflicting_IGV_bed = VariantFilter.clinvar_variants_conflicting_IGV_bed,
            rare_homozygous_variants_IGV_bed = VariantFilter.rare_homozygous_variants_IGV_bed,
            sampleID=samplename,
            memoryGb=memoryGb
    }
    ...
    call data_transfer_clinical{
        input:
            ...
            sampleGeneSummary = sampleGeneSummary,
            ...
            clinvar_variants_conflicting = VariantFilter.clinvar_variants_conflicting,
            rare_homozygous_variants = VariantFilter.rare_homozygous_variants,
            ...
            variants_PGx_IGV_snapshots = IGV_Snapshots.variants_PGx_IGV_snapshots,
            clinvar_variants_conflicting_IGV_snapshots = IGV_Snapshots.clinvar_variants_conflicting_IGV_snapshots,
            rare_homozygous_variants_IGV_snapshots = IGV_Snapshots.rare_homozygous_variants_IGV_snapshots,
            sampleID=samplename
    }
  ...
  output {
        ...
        File clinvar_variants_conflicting = VariantFilter.clinvar_variants_conflicting
        File rare_homozygous_variants = VariantFilter.rare_homozygous_variants
        File vep_coding_variants = VariantFilter.vep_coding_variants
        ...
        File variants_PGx_IGV_snapshots = IGV_Snapshots.variants_PGx_IGV_snapshots
        File clinvar_variants_conflicting_IGV_snapshots = IGV_Snapshots.clinvar_variants_conflicting_IGV_snapshots
        File rare_homozygous_variants_IGV_snapshots = IGV_Snapshots.rare_homozygous_variants_IGV_snapshots
  }
...
task vep_task {
    ...
    command <<<
        ...
        --custom ~{clinvar},~{clinvar_name},vcf,exact,0,ID,ALLELEID,CLNDN,CLNDISDB,CLNHGVS,CLNREVSTAT,CLNSIG,CLNSIGCONF,CLNVI,DBVARID 
...
task VariantFilter {
   ...
   command <<<
       Rscript ~{Rscript_file} ~{master_gene_list} ~{GOF_gene_list} ~{OMIM_genes} ~{Clinvar_genes} ~{GCD_genes} ~{clingen_gene_data} ~{input_vcf} ~{samplename} ~{chain}  
   >>>
...
task IGV_Snapshots {
    ...
    File variants_PGx_IGV_bed
    File clinvar_variants_conflicting_IGV_bed
    File rare_homozygous_variants_IGV_bed
    Int memoryGb
    Int addtional_disk_space_gb = 10
    Int disk_space_gb = ceil(size(inputCram, "GB")  * 2 ) + addtional_disk_space_gb
...
## variants_PGx:
    ...
    mv ~{variants_PGx_IGV_bed} /IGV-snapshot-automator/regions.bed
    ...
    mv IGV_Snapshots.tar.gz ~{sampleID}.IGV_Snapshots_PGx.tar.gz
    mv ~{sampleID}.IGV_Snapshots_PGx.tar.gz /cromwell_root
    
    echo "---- completed running IGV_Snapshots ----"



## clinvar_variants_conflicting:
    echo "moving input files to correct directory..."
    
    mv ~{clinvar_variants_conflicting_IGV_bed} /IGV-snapshot-automator/regions.bed
    ...
    mv IGV_Snapshots.tar.gz ~{sampleID}.IGV_Snapshots_clinvar_variants_conflicting.tar.gz
    mv ~{sampleID}.IGV_Snapshots_clinvar_variants_conflicting.tar.gz /cromwell_root
    
    echo "---- completed running IGV_Snapshots ----"



## rare_homozygous_variants:
    echo "moving input files to correct directory..."
    
    mv ~{rare_homozygous_variants_IGV_bed} /IGV-snapshot-automator/regions.bed
    ...
    mv IGV_Snapshots.tar.gz ~{sampleID}.IGV_Snapshots_rare_homozygous_variants.tar.gz
    mv ~{sampleID}.IGV_Snapshots_rare_homozygous_variants.tar.gz /cromwell_root
    ...
    output {
        ...
        File variants_PGx_IGV_snapshots = "~{sampleID}.IGV_Snapshots_PGx.tar.gz"
        File clinvar_variants_conflicting_IGV_snapshots = "~{sampleID}.IGV_Snapshots_clinvar_variants_conflicting.tar.gz"
        File rare_homozygous_variants_IGV_snapshots = "~{sampleID}.IGV_Snapshots_rare_homozygous_variants.tar.gz"
    }
...
task data_transfer_clinical {
    input {
        ...
        File variants_PGx
        File clinvar_variants_conflicting
        File rare_homozygous_variants
        File variants_HQ_IGV_snapshots
        File variants_HQ_non_clinical_IGV_snapshots
        File variants_LQ_IGV_snapshots
        File variants_PGx_IGV_snapshots
        File clinvar_variants_conflicting_IGV_snapshots
        File rare_homozygous_variants_IGV_snapshots
        String clinical_bucket_path
        String sampleID
    }
    ...
    command <<<
        ...
        gsutil -m cp ~{clinvar_variants_conflicting} ~{clinical_bucket_path}/~{sampleID}.clinvar_variants_conflicting.csv
        gsutil -m cp ~{rare_homozygous_variants} ~{clinical_bucket_path}/~{sampleID}.rare_homozygous_variants.csv
        ...
        gsutil -m cp ~{sampleSummary} ~{clinical_bucket_path}/
        gsutil -m cp ~{sampleGeneSummary} ~{clinical_bucket_path}/
