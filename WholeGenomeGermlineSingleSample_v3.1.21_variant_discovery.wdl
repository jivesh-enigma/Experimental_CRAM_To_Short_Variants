...
import "https://raw.githubusercontent.com/broadinstitute/warp/refs/tags/WholeGenomeReprocessing_v3.1.21/tasks/broad/GermlineVariantDiscovery.wdl" as Calling
import "https://raw.githubusercontent.com/broadinstitute/warp/refs/tags/WholeGenomeReprocessing_v3.1.21/tasks/broad/Qc.wdl" as QC
import "https://raw.githubusercontent.com/broadinstitute/warp/refs/tags/WholeGenomeReprocessing_v3.1.21/tasks/broad/Utilities.wdl" as Utils
import "https://raw.githubusercontent.com/broadinstitute/warp/refs/tags/WholeGenomeReprocessing_v3.1.21/tasks/broad/BamProcessing.wdl" as BamProcessing
import "https://raw.githubusercontent.com/broadinstitute/warp/refs/tags/WholeGenomeReprocessing_v3.1.21/tasks/broad/DragenTasks.wdl" as DragenTasks
...
workflow VariantCalling {
  ...
  input {
    ...
    Int mem_factor_HaplotypeCallerGATK4
  }
    ...
    if (!use_gatk3_haplotype_caller) {
      ...
      call Calling.HaplotypeCaller_GATK4_VCF as HaplotypeCallerGATK4 {
        input:
          ...
          preemptible_tries = agg_preemptible_tries,
          memory_multiplier = mem_factor_HaplotypeCallerGATK4
       }
